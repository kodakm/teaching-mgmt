...
static unsigned int sqlctx = 40789907;
...
{13,4130,178,0,0,
5,0,0,0,0,0,27,16,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,48,0,4,35,0,0,1,0,0,1,0,2,3,0,0,
55,0,0,3,104,0,3,37,0,0,5,5,0,1,0,1,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
90,0,0,4,0,0,29,42,0,0,0,0,0,1,0,
105,0,0,5,0,0,31,45,0,0,0,0,0,1,0,
120,0,0,6,0,0,30,48,0,0,0,0,0,1,0,
};
...
struct { unsigned short len; unsigned char arr[100]; } conn_string;

/* VARCHAR v_name[100], v_email[100], v_phone[15], v_course[50]; */ 
struct { unsigned short len; unsigned char arr[100]; } v_name;

struct { unsigned short len; unsigned char arr[100]; } v_email;

struct { unsigned short len; unsigned char arr[15]; } v_phone;

struct { unsigned short len; unsigned char arr[50]; } v_course;
...

{
    ...
    sqlstm.sqhstv[0] = (         void  *)&conn_string;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "select student_seq.nextval  into :b0  from dual ";
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "insert into students (student_id,name,email,phone,course,\
join_date) values (:b0,:b1,:b2,:b3,:b4,SYSDATE)";
    sqlstm.iters = (unsigned int  )1;
